...
```
cd existing_repo
git remote add origin https://vcs.uni-dubna.ru/VAN.21/2025-torrentserver.git
git branch -M main
...
- [ ] [Set up project integrations](https://vcs.uni-dubna.ru/VAN.21/2025-torrentserver/-/settings/integrations)
